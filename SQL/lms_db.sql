...
(8, 'Learn Guitar The Easy Wayy', 'This course is your \"Free Pass\" to playing guitar. It is the most direct and to the point complete online guitar course.', 'Adele', '../image/courseimg/Guitar.jpg', '3 Hours', 1655, 1800),
(9, 'Complete PHP Bootcamp', 'This course will help you get all the Object Oriented PHP, MYSQLi and ending the course by building a CMS system.', 'Mr. White', 'https://upload.wikimedia.org/wikipedia/commons/2/27/PHP-logo.svg', '3 Months', 700, 1700),
(10, 'Learn Python A-Z', 'This is the most comprehensive, yet straight-forward, course for the Python programming language.', 'Mr. Beans', 'https://cdn.gabrieleromanato.com/5c37214980b3/uploads/python-alt.png', '4 Months', 800, 1800),
(11, 'Hands-on Artificial Intelligence', 'Learn and Master how AI works and how it is changing our lives in this Course.\r\nlives in this Course.', 'Jay Riley', '../image/courseimg/ai.jpg', '6 Months', 900, 1900),
(12, 'Learn Vue JS', 'The skills you will learn from this course is applicable to the real world, so you can go ahead and build similar app.', 'Pak Shakur', '../image/courseimg/Vue.jpg', '2 Months', 100, 1000),
(13, 'Angular', 'Angular is one of the most popular frameworks for building client apps with HTML, CSS and TypeScript.', 'Sonia Abiola', '../image/courseimg/Angular.jpg', '4 Month', 800, 1600),
(16, 'Python Complete', 'This is complete Python COurse', 'RK', 'https://cdn.gabrieleromanato.com/5c37214980b3/uploads/python-alt.png', '4 hours', 500, 4000),
(17, 'Learn React Native', 'THis is react native for android and iso app development', 'Geek4Geeks', 'https://miro.medium.com/v2/resize:fit:720/format:webp/1*y6C4nSvy2Woe0m7bWEn4BA.png', '2 months', 200, 3000);
...
(7, 'ORDS57717951', 'jay@ilearn.com', 14, 'TXN_SUCCESS', 'Txn Success', 400, '2019-09-13'),
(8, 'ORDS22968322', 'mario@ilearn.com', 10, 'TXN_SUCCESS', 'Txn Success', 800, '2019-09-13'),
(9, 'ORDS78666589', 'ignou@ilearn.com', 10, 'TXN_SUCCESS', 'Txn Success', 800, '2019-09-19'),
(10, 'ORDS59885531', 'sonia@gmail.com', 10, 'TXN_SUCCESS', 'Txn Success', 800, '2020-07-04');
...
(3, 'My life at iLearn made me stronger and took me a step ahead for being an independent women. I am thankful to all the teachers who supported us and corrected us throughout our career. I am very grateful to the iLearn for providing us the best of placement opportunities and finally I got placed in DC Marvel.', 171),
(8, 'I am grateful to iLearn - both the faculty and the Training & Placement Department. They have made efforts ensuring maximum number of placed students. Due to the efforts made by the faculty and placement cell. I was able to bag a job in the second company.', 172),
(9, 'iLearn is a place of learning, fun, culture, lore, literature and many such life preaching activities. Studying at the iLearn brought an added value to my life.', 173),
(10, 'Think Magical, that is one thing that iLearn urges in and to far extent succeed in teaching to its students which invariably helps to achieve what you need.', 174),
...
(13, 'This is Awesome Just cant get enough', 182);
...
(176, ' Shaktiman', 'shaktiman@ilearn.com', '123456', 'Software Engineer', '../image/stu/shaktiman.jpg'),
(178, ' Mario', 'mario@ilearn.com', '1234567', ' Web Dev', '../image/stu/super-mario-2690254_1280.jpg'),
(182, ' sonia', 'sonia@gmail.com', '123456', ' Web Dev', '../image/stu/student2.jpg');
