...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">Welcome to iLearn</h1>
        <small class="my-content">Fostering academic excellence, innovation, and personal growth.</small><br />
        <?php    
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>iLearn <br> Near City Mall <br> Ikeja, Lagos <br> Pb.  10001 </p>
          </div>
        </div>
      </div>
