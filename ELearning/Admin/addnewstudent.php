...
include('../dbConnection.php');
 ...
 if(isset($_REQUEST['newStuSubmitBtn'])){
  ...
  if(($_REQUEST['stu_name'] == "") || ($_REQUEST['stu_email'] == "") || ($_REQUEST['stu_pass'] == "") || ($_REQUEST['stu_occ'] == "")){
   ...
   $imagePath = '../image/stu/user-avatar.png';

    $sql = "INSERT INTO student (stu_name, stu_email, stu_pass, stu_occ, stu_img) VALUES ('$stu_name', '$stu_email', '$stu_pass', '$stu_occ', '$imagePath')";
